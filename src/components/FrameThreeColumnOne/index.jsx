...
const FrameThreeColumnOne = (props) => {
  return (
    <>
          ...
          <div className="flex flex-col gap-2 items-start justify-start w-full">
            ...
            <Button
              ...
              leftIcon={
                <Img
                  className="h-5 mr-3"
                  src="images/img_icon_homesimpledoor.svg"
            ...
            <SelectBox
              className="!text-black-900 font-inter font-medium text-left text-sm tracking-[-0.28px] w-full"
...
FrameThreeColumnOne.defaultProps = {
...
export default FrameThreeColumnOne;
